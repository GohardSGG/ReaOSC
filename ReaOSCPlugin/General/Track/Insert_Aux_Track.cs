namespace Loupedeck.ReaOSCPlugin.General
{
    ...
    public class Insert_Aux_Track : PluginDynamicCommand
    {
        public static string fullName = "Insert Aux Track";
        public static string chineseName = "插入辅助轨道";
        public static string typeName = "Track";
        public Insert_Aux_Track()
            : base(
        ...
        {
            ReaOSCPlugin.SendGeneralMessage("Insert/Aux Track", 1);
