namespace Loupedeck.ReaOSCPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ReaOSCPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ReaOSCPlugin.Resources.Resource.txt`.
